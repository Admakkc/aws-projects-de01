...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/adem/capstone/username')
    password_param = ssm.get_parameter(Name="/adem/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'adm-capstone-rds.cziwe0giy0mr.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
